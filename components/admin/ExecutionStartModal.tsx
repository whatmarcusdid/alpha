...
export function ExecutionStartModal({
  isOpen,
  businessName,
  isSubmitting,
  error,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <button
        ...
        aria-label="Close execution start confirmation"
        onClick={onCancel}
      />
      <div className="relative z-10 w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
        <h2 className="text-xl font-semibold text-gray-950">Start fix execution?</h2>
        <p className="mt-2 text-base leading-[1.5] text-zinc-600">
          You&apos;re about to begin work on {businessName}. Make sure triage is complete and
          you&apos;re ready to start the fix loops.
        </p>
        {error && (
